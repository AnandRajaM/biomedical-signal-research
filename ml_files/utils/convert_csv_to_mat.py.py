...
mat_file_path = r'D:\dev\biomedical-signal-research\matlab_files\scidata_phase1\datasets\GDN0001\GDN0001_1_Resting.mat'  # Change to your .mat file path
mat_data = loadmat(mat_file_path)

# Load the CSV file for radar_i, radar_q, tfm_ecg1, tfm_ecg2
csv_file_path = r'D:\dev\biomedical-signal-research\matlab_files\converted_data.csv'  # Change to your CSV file path
...
data_dict = {
    ...
    'tfm_ecg2': csv_data['ecg2'].values.reshape(-1, 1).astype(np.float64) if 'ecg2' in csv_data.columns else np.array([]).reshape(-1, 1),
...
new_mat_file_path = r'D:\dev\biomedical-signal-research\combined_data.mat'  # Change to your desired output path
